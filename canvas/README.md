...
#### [组合图形](https://www.cnblogs.com/hzj680539/p/5068487.html)
  - globalCompositeOperation
    ...
    - destination-over
      - 在原有图形之下绘制图形
    - source-in
      - 新图行与原有图形做 in 运算，只显示新图形 与 原有图形 相重叠部分，新图行与原有图形的其他部分均保持重合
    - destination-in
      - 原有图形与新图形做 in 运算，只显示原有图形 与新图形 相重叠部分，新图行与原有图形的其他部分均保持重合
    - source-out
      - 新图行与原有图形做 in 运算，只显示新图形 与 原有图形 不重叠部分，新图行与原有图形的其他部分均保持重合
    - destination-out
      - 原有图形与新图形做 in 运算，只显示原有图形 与新图形 不重叠部分，新图行与原有图形的其他部分均保持重合
    - source-atop
